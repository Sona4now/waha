  ...
  "wadi-degla": [
    {
      ...
      rainDays: 1,
      suitability: "excellent",
      note: "الجو المثالي للهايكنج — منعش ومريح",
    },
    {
      season: "الربيع",
      months: "مارس — مايو",
      ...
      rainDays: 0,
      suitability: "excellent",
      note: "أفضل وقت للوادي — الزهور البرية مزدهرة",
    },
    {
      season: "الصيف",
      months: "يونيو — أغسطس",
      ...
      rainDays: 0,
      suitability: "poor",
      note: "الكانيون بيتحول لمصيدة حرارة — تجنّبه",
    },
    {
      season: "الخريف",
      months: "سبتمبر — نوفمبر",
      ...
      rainDays: 0,
      suitability: "excellent",
      note: "ممتاز — جو معتدل والجو نقي بعد الصيف",
    },
  ],
  "shagie-farms": [
    {
      ...
      rainDays: 1,
      suitability: "good",
      note: "جو لطيف — مناسب للزيارات العائلية",
    },
    {
      season: "الربيع",
      months: "مارس — مايو",
      ...
      rainDays: 1,
      suitability: "excellent",
      note: "الربيع في الإسماعيلية — البساتين بأجمل صورها",
    },
    {
      season: "الصيف",
      months: "يونيو — أغسطس",
      ...
      rainDays: 0,
      suitability: "excellent",
      note: "موسم حصاد المانجو — التجربة الكاملة",
    },
    {
      season: "الخريف",
      months: "سبتمبر — نوفمبر",
      ...
      rainDays: 1,
      suitability: "excellent",
      note: "جو رائع + استمرار موسم الحصاد",
    },
  ],
};
