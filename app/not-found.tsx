    ...
    >
      <div className="text-center px-6 max-w-md">
        ...
        <h1 className="text-2xl font-bold font-display mb-3">
          {isEn ? "Page not found" : "الصفحة مش موجودة"}
        </h1>
        <p className="text-white/50 mb-8 leading-relaxed">
          {isEn
            ? "Looks like you took a wrong turn. The page you're looking for doesn't exist or has moved."
        ...
        <div className="flex gap-3 justify-center flex-wrap">
          ...
          >
            {isEn ? "Explore destinations" : "استكشف الأماكن"}
          </Link>
        </div>
      </div>
    </div>
